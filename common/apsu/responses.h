...
namespace apsu {
    ...
    */
    ...
    {
        if (nullptr == response ||
            response->type() != apsu::network::SenderOperationType::sop_parms)
            return nullptr;
        return ParamsResponse(
            static_cast<apsu::network::SenderOperationResponseParms *>(response.release()));
    }
    ...
    {
        if (nullptr == response || response->type() != apsu::network::SenderOperationType::sop_oprf)
            return nullptr;
        return OPRFResponse(
            static_cast<apsu::network::SenderOperationResponseOPRF *>(response.release()));
    }
    ...
    {
        if (nullptr == response ||
            response->type() != apsu::network::SenderOperationType::sop_query)
            return nullptr;
        return QueryResponse(
            static_cast<apsu::network::SenderOperationResponseQuery *>(response.release()));
    }
