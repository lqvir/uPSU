...
#ifndef FLATBUFFERS_GENERATED_SENDERDB_APSU_FBS_H_
#define FLATBUFFERS_GENERATED_SENDERDB_APSU_FBS_H_
...
struct SenderDB FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const apsu::fbs::SenderDBInfo *info() const {
    return GetStruct<const apsu::fbs::SenderDBInfo *>(VT_INFO);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<apsu::fbs::SenderDBInfo>(verifier, VT_INFO, 8) &&
...
struct SenderDBBuilder {
  ...
  void add_info(const apsu::fbs::SenderDBInfo *info) {
...
inline flatbuffers::Offset<SenderDB> CreateSenderDB(
    ...
    const apsu::fbs::SenderDBInfo *info = nullptr,
...
inline flatbuffers::Offset<SenderDB> CreateSenderDBDirect(
  ...
  return apsu::fbs::CreateSenderDB(
      _fbb,
      params__,
      info,
      oprf_key__,
...
inline const apsu::fbs::SenderDB *GetSenderDB(const void *buf) {
  return flatbuffers::GetRoot<apsu::fbs::SenderDB>(buf);
}

inline const apsu::fbs::SenderDB *GetSizePrefixedSenderDB(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<apsu::fbs::SenderDB>(buf);
}

inline bool VerifySenderDBBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<apsu::fbs::SenderDB>(nullptr);
}

inline bool VerifySizePrefixedSenderDBBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<apsu::fbs::SenderDB>(nullptr);
}

inline void FinishSenderDBBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<apsu::fbs::SenderDB> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_SENDERDB_APSU_FBS_H_
