...
enum SenderOperationType : uint32_t {
  ...
  SenderOperationType_MAX = SenderOperationType_sop_query
};

inline const SenderOperationType (&EnumValuesSenderOperationType())[4] {
...
inline const char *EnumNameSenderOperationType(SenderOperationType e) {
  if (flatbuffers::IsOutRange(e, SenderOperationType_sop_unknown, SenderOperationType_sop_query)) return "";
